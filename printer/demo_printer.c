...
LV_FONT_DECLARE(lv_demo_printer_img_wave)
LV_FONT_DECLARE(lv_demo_printer_img_btn_bg)
LV_FONT_DECLARE(lv_demo_printer_img_usb)
LV_FONT_DECLARE(lv_demo_printer_img_mobile)
LV_FONT_DECLARE(lv_demo_printer_img_internet)
LV_FONT_DECLARE(lv_demo_printer_img_scan_example)
LV_FONT_DECLARE(lv_demo_printer_icon_bright)
LV_FONT_DECLARE(lv_demo_printer_icon_hue)
LV_FONT_DECLARE(lv_demo_printer_icon_wifi)
LV_FONT_DECLARE(lv_demo_printer_icon_tel)
LV_FONT_DECLARE(lv_demo_printer_icon_eco)
LV_FONT_DECLARE(lv_demo_printer_icon_pc)
LV_FONT_DECLARE(lv_demo_printer_img_copy)
LV_FONT_DECLARE(lv_demo_printer_img_scan)
LV_FONT_DECLARE(lv_demo_printer_img_print)
LV_FONT_DECLARE(lv_demo_printer_img_setup)
LV_FONT_DECLARE(lv_demo_printer_img_printer2)
LV_FONT_DECLARE(lv_demo_printer_img_no_internet)
LV_FONT_DECLARE(lv_demo_printer_img_cloud)
LV_FONT_DECLARE(lv_demo_printer_img_phone)
//LV_FONT_DECLARE(lv_demo_printer_img_ready)

extern const lv_img_dsc_t lv_demo_printer_img_ready;
